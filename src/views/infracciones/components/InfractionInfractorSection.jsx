    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="col-span-2">
          ...
          <EditableField
            editing={editing}
            value={data.propietario?.nombreCompleto}
            onChange={(v) => setNested("denunciado", "nombre", v)}
          />
        </div>
        <div>
          ...
          <EditableField
            editing={editing}
            value={data.propietario?.rut}
            onChange={(v) => setNested("denunciado", "rut", formatRUT(v))}
            mono
          />
        </div>
        <div>
          ...
          <EditableField
            editing={editing}
            value={data.propietario?.edad}
            onChange={(v) => setNested("denunciado", "edad", v)}
            type="number"
          />
        </div>
        <div className="col-span-2">
          ...
          <EditableField
            ...
            onChange={(v) => setNested("denunciado", "direccion", v)}
          />
        </div>
        <div>
          <p className="text-[10px] font-bold text-slate-400 uppercase">
          ...
          <EditableField
            editing={editing}
            value={data.propietario?.comuna}
            onChange={(v) => setNested("denunciado", "comuna", v)}
          />
        </div>
        <div>
          <p className="text-[10px] font-bold text-slate-400 uppercase">
          ...
          <EditableField
            editing={editing}
            value={data.propietario?.estadoCivil}
            onChange={(v) => setNested("denunciado", "estadoCivil", v)}
        ...
        <div className="col-span-2">
          ...
          <EditableField
            editing={editing}
            value={data.propietario?.profesion}
            onChange={(v) => setNested("denunciado", "profesion", v)}
          />
        </div>
      </div>
    </div>
