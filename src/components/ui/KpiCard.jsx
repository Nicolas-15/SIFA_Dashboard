...
export function KpiCard({ title, value, color, icon }) {
  ...
  return (
    <div
      className="bg-white border border-slate-200 rounded-2xl p-4 md:p-5 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
      onClick={(e) => {
    ...
    >
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          ...
          <p className={`text-3xl md:text-4xl font-black mt-1.5 ${s.num}`}>
            {value}
          </p>
        </div>
